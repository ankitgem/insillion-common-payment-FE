...
@Component({
  selector: 'app-insillion-receipt',
  imports: [CommonModule, ReactiveFormsModule, NgSelectModule,FormsModule,BsDatepickerModule],
  templateUrl: './insillion-receipt.html',
  styleUrl: './insillion-receipt.css'
})
export class InsillionReceipt {
selectedCityId: number | null = null;
  form!: FormGroup;

  // Adapted to your new JSON structure
  customerLink: Field[] = formConfig.insillionReceiptPayment || [];
